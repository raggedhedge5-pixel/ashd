...
import com.timesmp.plugin.combat.CombatCommandBlockListener;
...
public class TimeSMP extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        rankManager = new RankManager(this, dataStore, worldFilter, luckPermsHook);
        scoreboardManager = new ScoreboardManager(this, dataStore, rankManager, luckPermsHook);
        ...
        if (luckPermsHook.isAvailable()) {
            getLogger().info("LuckPerms detected - appending player suffixes to tab-list/nametags.");
        }
        ...
        getServer().getPluginManager().registerEvents(
                new CombatListener(this, dataStore, questManager, rankManager, extraInventoryManager, worldFilter, pvpKillResolver, combatManager), this);
        getServer().getPluginManager().registerEvents(
        ...
        getServer().getPluginManager().registerEvents(
                new CombatCommandBlockListener(combatManager, combatConfig), this);
